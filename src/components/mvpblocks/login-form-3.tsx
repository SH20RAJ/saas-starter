              ...
              <div className="mx-auto w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="block w-full rounded-lg border border-border bg-input py-3 pl-10 pr-3 text-sm"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="block w-full rounded-lg border border-border bg-input py-3 pl-10 pr-12 text-sm"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      type="button"
                      className="flex items-center justify-center rounded-lg border border-border bg-secondary px-4 py-2.5 text-sm text-foreground shadow-sm hover:bg-secondary/80"
                    >
                      <img
